...
const translations: Record<string, string> = {
  ...
  'dashboard.module5.desc': 'Prediksi permasalahan dari waktu ke waktu',
  'dashboard.module6.title': '6. Simulasi Sistem',
  'dashboard.module6.desc': 'Saksikan simulasi dampak sistem plastik secara real-time',
  ...
  'guide.step1.desc': 'Lengkapi 8 modul interaktif untuk memahami permasalahan plastik dalam perspektif sistem.',
  ...
  'guide.step4.desc': 'Pelajari untuk berpikir secara sistemik dan temukan solusi berkelanjutan untuk krisis plastik.',
  ...
  'problem.systemThinking': 'Karena itu, untuk memahami dan mengatasi krisis plastik, kita perlu melihatnya sebagai sebuah sistem permasalahan yang kompleks.',
  'problem.systemThinking.title': 'Dalam berpikir sistem, kita perlu memperhatikan:',
  'problem.mindset.connections': 'Hubungan antar komponen dalam permasalahan plastik',
  'problem.mindset.feedback': 'Dampak yang saling memengaruhi antar komponen permasalahan plastik',
  'problem.mindset.delays': 'Perubahan yang terjadi seiring waktu dalam permasalahan plastik',
  'problem.mindset.leverage': 'Bagian mana yang dapat diubah agar menyelesaikan permasalahan plastik secara efektif',
  'problem.ready': 'Siap melihat seluruh permasalahan?',
  'problem.continue': 'Lanjutkan',
  
  // Navigation
  'nav.dashboard': 'Dasboard',
  'nav.back': '← Dasboard',
  
  // Aktivitas Drag Drop
  'dragdrop.title': 'Identifikasi Komponen Sistem',
  'dragdrop.description': 'Seret komponen yang benar ke dalam lingkaran daur hidup plastik sekali pakai. Hindari pengalih perhatian!',
  'dragdrop.available': 'Komponen Tersedia',
  'dragdrop.plastic': 'Permasalahan Plastik',
  ...
  'dragdrop.message': 'Anda telah mengidentifikasi semua komponen permasalahan plastik yang benar. Anda berpikir seperti seorang analis sistem!',
  'dragdrop.next': 'Selanjutnya → Petakan Koneksi hubungan antar komponen permasalahan plastik',
  'dragdrop.score': 'Skor:',
  ...
  // Aktivitas Koneksi
  'connection.title': 'Petakan Koneksi Hubungan Antar Komponen',
  ...
  'dynamic.description': 'Permasalahan plastik berubah seiring waktu. Prediksi bagaimana komponen permasalahan lainnya akan merespons peningkatan produksi.',
  ...
  'dynamic.analyze': 'Analisis grafik di bawah ini dan prediksi dampak pada komponen permasalahan lainnya.',
  ...
  'simulation.description': 'Saksikan bagaimana dampak menyebar di berbagai tingkat sistem dari produksi hingga dampak pada manusia. Perhatikan keterkaitan dan efek riak di seluruh sistem.',
  ...
  'greenchem.description': 'Jelajahi 12 Prinsip yang dapat mengatasi permasalahan plastik',
  ...
  'greenchem.spotlight': 'Sorotan Solusi Plastik: Evolusi Penggunaan Plastik Sekali Pakai',
  ...
  'greenchem.application': 'Aplikasi pada Permasalahan Plastik',
  ...
  'systemViz.networkTitle': 'Jaringan Daur Hidup Plastik Sekali Pakai',
  'systemViz.instruction': 'Klik pada simpul mana pun untuk menjelajahi perannya dalam permasalahan plastik. Setiap komponen terhubung.',
  'systemViz.insightTitle': '💡 Wawasan Berpikir Sistem',
  'systemViz.insightText': 'Perhatikan bagaimana setiap komponen permasalahan saling terhubung. Perubahan di satu bagian mempengaruhi banyak bagian lainnya. Inilah esensi dari berpikir sistem - memahami hubungan, bukan hanya bagian-bagian individual.',
  'systemViz.continue': 'Lanjutkan',
  'systemViz.dialogSubtitle': 'Jelajahi peran dan dampak komponen ini dalam permasalahan plastik khususnya dalam daur hidup plastik sekali pakai. Perhatikan bagaimana setiap komponen saling memengaruhi dan berkontribusi pada krisis plastik secara keseluruhan.',
